...
#define EXPECT_EQ(value1, value2) if ((value1) != (value2)) {\
                                    assert(0);\
}

#define EXPECT_GT(value1, value2) if (!((value1) > (value2))) {\
                                    assert(0);\
}


#define EXPECT_NE(value1, value2) if ((value1) == (value2)) {\
                                    assert(0);\
}
#define ASSERT_EQ(value1, value2) EXPECT_EQ(value1, value2)
